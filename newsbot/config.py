...
# крок cron-job.org має бути МЕНШИМ за ці числа (рекомендовано ~15 хв, можна й
# менше), щоб не він, а САМЕ ці інтервали (тобто гарячість новин) визначали
# фактичний темп постингу. Якщо крок cron більший за інтервал — обмежувачем
# знову стає він, і темп перестає залежати від новин.
DAY_INTERVAL_HOT = 8       # вдень, якщо новина гаряча
DAY_INTERVAL_NORMAL = 12   # вдень, звичайна новина
NIGHT_INTERVAL_HOT = 73    # вночі, гаряча
NIGHT_INTERVAL_NORMAL = 110  # вночі, звичайна
