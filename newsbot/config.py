...
DAY_INTERVAL_HOT = 12      # вдень, якщо новина гаряча
DAY_INTERVAL_NORMAL = 18   # вдень, звичайна новина (менше за крок запусків 20-30 хв,
                           # щоб КОЖЕН запуск міг постити — без пропусків по годині)
...
CONSENSUS_AGE_MIN = 45      # вікно синхронності, хвилин
