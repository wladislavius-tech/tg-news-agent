...
ALBUM_MAX_PHOTOS = 3
# Скільки посилань галереї збирати зі статті (беремо перші — вони найрелевантніші).
# Стеля лише щоб не тягнути сотню URL зі сторінок-добірок.
GALLERY_MAX_URLS = 8
# Від скількох кадрів у галереї вважаємо статтю фоторепортажем і збираємо альбом
GALLERY_ALBUM_MIN = 2
