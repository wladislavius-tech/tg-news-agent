...
# (cron-job.org, зараз 15 хв) — інакше перша ж перевірка після посту часто не
# встигає (число з діапазону випадає БІЛЬШИМ за крок), і реальний інтервал
# стрибає одразу до наступного кроку (тут: 30 хв замість задуманих ~15).
# NIGHT_* — виняток: там діапазони й так набагато ширші за крок, тому
# квантування на кроці запусків не помітне.
DAY_INTERVAL_HOT = (5, 10)       # вдень, якщо новина гаряча
DAY_INTERVAL_NORMAL = (10, 14)   # вдень, звичайна новина
