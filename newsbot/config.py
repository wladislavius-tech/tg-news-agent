...
# (не крок cron-job.org, який має бути МЕНШИМ за ці числа, рекомендовано ~15 хв,
# можна й менше). Кожен інтервал — діапазон (від, до): фактичне число
# перемішується у ньому окремо для кожного вікна очікування (main.allowed_to_post),
# тож пости йдуть не рівним кроком, а "десь 15, десь 19, десь 20 хв".
DAY_INTERVAL_HOT = (5, 10)       # вдень, якщо новина гаряча
DAY_INTERVAL_NORMAL = (15, 20)   # вдень, звичайна новина
