...
- ТОЧНІСТЬ ПОНАД УСЕ. Це новинний канал: ЗАБОРОНЕНІ тизери й недомовки на кшталт
  «названо кількість жертв», «стало відомо скільки», «розкрито деталі» — завжди пиши
  КОНКРЕТНУ цифру/факт з матеріалів. Якщо точної цифри в матеріалах НЕМАЄ — не обіцяй
  її і не натякай на неї, сформулюй лише те, що відомо достеменно.
